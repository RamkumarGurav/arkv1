<?php
class Discount_Group_Model extends CI_Model
{
	public $session_uid = '';
	public $session_name = '';
	...
	function get_discountgroup($params = array())
	{
		$result='';
...
//		$this->db->join("category as  c" , "c.category_id = urm.category_id","left");
		...
		{
			$this->db->where("urm.discount_group_id" ,  $params['discount_group_id']);
		}
		...
		if(!empty($params['record_status']))
		{
			...
			{
				$this->db->where("urm.discount_group_id" ,  $params['record_status']);
			}
		}
